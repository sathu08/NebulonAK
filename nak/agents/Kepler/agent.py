"""
nak.agents.Kepler.agent -- generated skeleton (confirm-gated).
...
Usage:
    from nak.agents.Kepler.agent import Agent
...
class Agent:
    """Kepler — handles: Reusable planning agent: creates implementation plans, roadmaps and designs for any task or stack (not tied to one framework)"""
    ...
    def __init__(self, brain: Optional[Brain] = None, system_prompt: Optional[str] = None) -> None:
        ...
        default_hint = "You are Kepler, a helpful assistant for reusable planning."
